...
import { deleteTask, editTasks, getTasks } from "../../api";
...
function PopBrowse() {
  ...
  function getColorTopic() {
    if (currentTask?.topic === "Research") {
      return "_green";
    }
    if (currentTask?.topic === "Web Design") {
      return "_orange";
    }
    if (currentTask?.topic === "Copywriting") {
      return "_purple";
    }
  }
        ...
        <div className="pop-browse__block">
          <div className="pop-browse__content">
            <div className="pop-browse__top-block">
              ...
              <div
                className={`categories__theme theme-top ${getColorTopic()} _active-category`}
              >
                <p className={getColorTopic()}>{currentTask?.topic}</p>
              </div>
            </div>
            <div className="pop-browse__status status">
              ...
              <div className="status__themes">
                <div
                  onClick={() => changeStatus("Без статуса")}
                  className={`status__theme ${
                    currentTask?.status === "Без статуса" ? "_gray" : ""
                  } `}
                >
                  <p
                    className={`${
                ...
                <div
                  onClick={() => changeStatus("Нужно сделать")}
                  className={`status__theme ${
                    currentTask?.status === "Нужно сделать" ? "_gray" : ""
                  } `}
                >
                  <p
                    className={`${
                ...
                <div
                  onClick={() => changeStatus("В работе")}
                  className={`status__theme ${
                    currentTask?.status === "В работе" ? "_gray" : ""
                  }`}
                >
                  <p
                    className={`${
                ...
                <div
                  onClick={() => changeStatus("Тестирование")}
                  className={`status__theme ${
                    currentTask?.status === "Тестирование" ? "_gray" : ""
                  }`}
                >
                  <p
                    className={`${
                ...
                <div
                  onClick={() => changeStatus("Готово")}
                  className={`status__theme ${
                    currentTask?.status === "Готово" ? "_gray" : ""
                  }`}
                >
                  <p
                    className={`${
            ...
            <div className="pop-browse__btn-browse ">
              <div className="btn-group">
                ...
                <button
                  onClick={() => deleteTaskHandler(cardId)}
